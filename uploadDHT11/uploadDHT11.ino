...
#define SENSORID2 4698 // 更换传感器IDreplace your sensor ID
...
// this method makes a HTTP connection to upload Temperature data to the server:
void sendData1(float thisData) {
...
// this method makes a HTTP connection to upload Humidity data to the server:
void sendData2(float thisData) {
  // if there's a successful connection:
  if (client.connect(server, 80)) {
    Serial.println("connecting...");
    // send the HTTP PUT request:
